...
namespace EcommerceV1.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(EcommerceV1Context context)
        {
            _context = context;
        }
        ...
        {
            ViewData["RoleData"] = new SelectList(_context.Roles, "RoleId", "RoleName");

            List<SelectListItem> IsStatus = new List<SelectListItem>();
            IsStatus.Add(new SelectListItem() { Text = "Đã kích hoạt", Value = "1" });
            IsStatus.Add(new SelectListItem() { Text = "Chưa kích hoạt", Value = "0" });
