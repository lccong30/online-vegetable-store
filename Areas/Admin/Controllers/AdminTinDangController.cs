...
namespace EcommerceV1.Areas.Admin.Controllers
{
    ...
    public class AdminTinDangController : Controller
    {
        ...
        public AdminTinDangController(EcommerceV1Context context, INotyfService notyfService)
        {
            _context = context;
            _notyfService = notyfService;
        }

        // GET: Admin/AdminTinDang
        public IActionResult Index(int? page)
        {
            ...
            {
                url = item.Title + item.PostId;
                if (item.CreatedDate == null)
                {
                    item.CreatedDate = DateTime.Now;

                    item.Alias = Utilities.SEOUrl(url);
        ...
        // GET: Admin/AdminTinDang/Details/5
        ...
        // GET: Admin/AdminTinDang/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Admin/AdminTinDang/Create
        ...
        // POST: Admin/AdminTinDang/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/AdminTinDang/Delete/5
        ...
        // POST: Admin/AdminTinDang/Delete/5
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EcommerceV1Context.TinDangs'  is null.");
            }
            var tinDang = await _context.TinDangs.FindAsync(id);
            if (tinDang != null)
            {
