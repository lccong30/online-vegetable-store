...
public partial class EcommerceV1Context : DbContext
{
    public EcommerceV1Context()
    {
    }
...
//        => optionsBuilder.UseSqlServer("Server=.; Database=EcommerceV1; Integrated Security=True;TrustServerCertificate=true;", x => x.UseNetTopologySuite());
    ...
    public DbSet<EcommerceV1.ViewModels.RegisterVM> RegisterVM { get; set; } = default!;

    public DbSet<EcommerceV1.ViewModels.LoginVM> LoginVM { get; set; } = default!;
}
